      ...
      <header className="border-b border-zinc-800 bg-zinc-950/90 backdrop-blur sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-sm font-medium text-zinc-300">Intelligence Briefs</h1>
          </div>
          <nav className="flex gap-3 text-sm">
            ...
            <Link href="/sources" className="text-zinc-400 hover:text-white transition-colors">Sources</Link>
          </nav>
        </div>
      </header>
